...
<?php } ?>
    ...
    <h1 class="tab center bounds padding active"><span class="toptitle"><strong>JEANS</strong></span></h1>
    <?php $req = $bdd->query('SELECT * FROM produit WHERE id_categorie= 2 AND id_sous_ctg= 4'); ?> <!-- on demande les articles de la table produits -->
    ...
    <div class="bounds padding">
                ...
                <div href="" class="item zoom active">
        	        ...
        	        <div class="column">
                    <div class="image">		        
                        <img src="photos/homme/jeans/<?php echo $row['photos_pdt']; ?>" alt=""> 
			        ...
			        <div class="column">
				        <div class="text">
                            ...
                            <h6><a href="jeans_homme.php?ajouter=<?php echo $row['id_produit'] ?>"><img src="heart.svg"></a></H6>		
