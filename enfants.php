...
<hr />
    ...
    <video src="zarakids.mp4" autoplay="true" loop height="500px" width="900px" muted="muted"></video>
</div>
</div>
...
<div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6">
            <tr>
                <th><a href="manteaux_enfant.php"><img class="manteaux" src="categories/manteaux_e.jpg"></th>
                <th></th>
                <th><a href="jeans_enfant.php"><img class="jeans" src="categories/jeans_e.jpg"></th>
                <th></th>
                <th><a href="sweats_enfant.php"><img class="sweats" src="categories/sweat_e.jpg"></th>
            </tr>

            <tr>
                <td><a href="manteaux_enfant.php" class="manteaux" style="text-decoration:none; color:white">MANTEAUX</a></td>
                <th></th>
                <td><a href="jeans_enfant.php" class="jeans" style="text-decoration:none; color:white">JEANS</a></td>
                <th></th>
                <td><a href="sweats_enfant.php" class="sweats" style="text-decoration:none; color:white">SWEATS</a></td>
            </tr>
            </table>
    </div>
</div>
