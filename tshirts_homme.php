...
<?php } ?>
    ...
    <h1 class="tab center bounds padding active"><span class="toptitle"><strong>T-SHIRTS HOMME</strong></span></h1>
    <?php $req = $bdd->query('SELECT * FROM produit WHERE id_categorie= 2 AND id_sous_ctg= 3'); ?> <!-- on demande les articles de la table produits -->
    ...
    <div class="bounds padding">
                ...
                <div href="" class="item zoom active">
        	        ...
        	        <div class="column">
                    <div class="image">		        
                        <img src="photos/homme/tshirts/<?php echo $row['photos_pdt']; ?>" alt=""> 
			        ...
			        <div class="column">
				        <div class="text">
                            ...
                            <h3><i class="price"><?php echo $row['prix_pdt']; ?> €</i></h3>
